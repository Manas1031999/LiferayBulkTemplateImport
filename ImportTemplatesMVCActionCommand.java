package com.liferay.bulk.template.importer.action;

import com.liferay.bulk.template.importer.constants.LiferayBulkTemplateImportPortletKeys;
import com.liferay.bulk.template.importer.utils.CSVUtils;
import com.liferay.bulk.template.importer.utils.ZipUtils;
...
@Component(
	    property = {
	        "javax.portlet.name="+LiferayBulkTemplateImportPortletKeys.LIFERAYBULKTEMPLATEIMPORT,
                ...
                if (existingTemplate != null) {
                    if (overwriteExisting) {
                        try {
                            ...
                            nm.put(LocaleUtil.getDefault(), (nameRaw.isEmpty() ? (templateKey.isEmpty() ? externalReferenceCode : templateKey) : nameRaw));
                    ...
                    try {
                        DDMTemplate created = ddmTemplateLocalService.addTemplate(
                            ...
                            Map.of(LocaleUtil.getDefault(), (nameRaw.isEmpty() ? (templateKey.isEmpty() ? externalReferenceCode : templateKey) : nameRaw)),
                            Map.of(LocaleUtil.getDefault(), "Imported by CSV+ZIP importer"),
